...
// วางรูป ESD ใน public/screenshots/esd/1.png, 2.png, 3.png ...
const esdImages = [
...
// วางรูป KPI ใน public/screenshots/kpi/1.png, 2.png, 3.png ...
const kpiImages = [
...
const kpiSteps = [
  { icon: "📝", label: "Preparer<br/>Submits KPI", sub: "Multi-KPI form<br/>per dept", color: "rgba(99,102,241,0.15)", border: "#4f46e5" },
  { icon: "📧", label: "Auto Email<br/>to Manager", sub: "Approval<br/>request link", color: "rgba(14,165,233,0.1)", border: "#0284c7" },
  { icon: "✅", label: "Manager<br/>Approves", sub: "KPI Approval<br/>queue", color: "rgba(0,212,170,0.1)", border: "#00d4aa" },
  { icon: "📊", label: "QMR Monitors<br/>All Depts", sub: "Matrix<br/>dept × month", color: "rgba(245,158,11,0.1)", border: "#d97706" },
  { icon: "📈", label: "Dashboard<br/>Visualizes", sub: "Chart.js<br/>real-time", color: "rgba(34,197,94,0.1)", border: "#16a34a" },
  { icon: "📋", label: "Management<br/>Review Report", sub: "Auto-generated<br/>ISO 9001 ready", color: "rgba(168,85,247,0.1)", border: "#9333ea" },
];

const features = [
  { icon: "🔒", title: "RBAC Authentication", desc: "13 roles, granular permissions. HMAC-SHA256, CSRF protection, 6-hour session watchdog." },
  { icon: "📧", title: "Email Automation", desc: "Auto-notify approvers, ESD reminders, KPI alerts — GAS MailApp with deep-link routing." },
  ...
  { icon: "🔄", title: "Change Request Workflow", desc: "KPI Change Request with approval chain and history tracking per ISO 9001 requirements." },
  { icon: "🔗", title: "Deep Link Navigation", desc: "Email links open directly to approval pages — no re-login required for approvers." },
...
export default function ESDPage() {
  return (
    <>
      ...
      {/* ESD SECTION */}
      <section className="border-t border-[#1e2d4a] py-16">
        <div className="mx-auto max-w-5xl px-8">
          <div className="mb-10">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[rgba(0,212,170,0.3)] bg-[rgba(0,212,170,0.08)] px-3 py-1 text-[11px] text-[#00d4aa]">
              <span className="live-dot h-2 w-2 rounded-full bg-[#00d4aa] inline-block" />
              Live — Production
            </div>
            <h2 className="mb-3 text-4xl font-extrabold text-white leading-tight">ESD Control System</h2>
            <p className="mb-4 text-sm text-[#64748b] leading-relaxed max-w-2xl">
          ...
          <div className="mb-2 text-[10px] uppercase tracking-widest text-[#00d4aa]">// ESD System Workflow</div>
          <h3 className="mb-2 text-xl font-bold text-[#f1f5f9]">Inspection → Approval → Record Pipeline</h3>
          <p className="mb-10 text-xs text-[#475569]">6-step closed-loop — form submission to Google Sheets audit trail</p>
      ...
      <section className="border-t border-[#1e2d4a] py-20" style={{ background: "rgba(6,9,26,0.6)" }}>
        <div className="mx-auto max-w-5xl px-8">
          ...
          <h3 className="mb-10 text-xl font-bold text-[#f1f5f9]">Shared Architecture</h3>
          ...
          <div key={i} className="relative flex items-center flex-1">
            ...
            <div className="flex flex-col items-center z-10 flex-1">
              ...
              <div className="relative mb-4">
                ...
                />
                <div
                  className="relative w-14 h-14 rounded-full flex items-center justify-center text-xl border-2 z-10"
                  style={{
              ...
              />
              <div
                className="text-[10px] text-[#475569] text-center leading-tight"
